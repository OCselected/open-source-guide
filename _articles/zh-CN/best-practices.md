...
locale: zh-CN
title: 维护者最佳实践
description: 身为开源的维护者，该如何做的更好？本指南将会事无巨细的帮助你成为一名合格的开源项目维护者，从文档流程、社区管理、乃至矛盾调解，无所不包。
...
有时候，当你说不的时候，你潜在的贡献者会感到沮丧或者心情不佳。如果他们开始找你撕逼了，[采取必要的措施以应对局势](https://github.com/jonschlinkert/maintainers-guide-to-staying-positive#action-items)，如果他们不打算和你保持建设性的合作关系的话，干脆把他们从你的社区开除。
