...
* **清楚的解释如何做贡献**，使用[你的 CONTRIBUTING 文件](https://github.com/liadbiz/opensource-contribute-guide-chinise/blob/master/github-open-source-guide-02.md#编写你的贡献指南)以及持续更新issues。
...
鼓励其他的贡献者也是对项目的一种投资。当你去授权大量的粉丝做他们感兴趣的工作时，压力就会少很多。
...
书写内容绝不仅仅只是技术文档。任何时刻，你们有写一些东西或者私自讨论项目的冲动，请询问自己是否能将之公开。
...
记录一切也适用于你自身的工作。如果你正在进行大量的更新工作，请将其放入PR，并标记为正在进行（WIP）。这样，可以让其他人感觉参与过早期的工作。
...
与项目有关的话题也可能发生在互联网的其它地方，例如Stack Overflow、Twitter、或者 Reddit。你可以在像这样的一些网站设置通知，这样当有人提及项目时，可以即时的收到提醒。
...
公共交流和指明人们开一条 issue 一样简单，而不是直接发送电子邮件或者在博客上发表评论。你也可以为了方便人们谈论项目设置一个邮件列表，或者创建一个Twitter账号，Slack，IRC频道。或者尝试上述的所有方式。
...
对项目的微不足道的问题进行定期辩论会分散别人的注意力，包括你自己，要将精力集中在重要的任务上。新人如果看见人们将大量精力浪费在琐碎的事情上这样的情景，他们可能不会加入到项目中来。

当发现社区中有消极的行为时，要即时、公开的指出来。特别说明的是，要用坚定的语气解释他们的行为为什么是不可接受的。如果这种问题继续发生，你有必要[要求他们离开](https://github.com/cnbo/open-source-guide/blob/gh-pages/_articles/code-of-conduct.md#enforcing-your-code-of-conduct)。你的[行为准则](https://github.com/cnbo/open-source-guide/blob/gh-pages/_articles/code-of-conduct.md)是为这些情景准备的建设性指南。
...
要尽可能地与你的社区分享所有权，并尝试各种各样的方法，这里有一些经验和大家分享：
...
* **给每个贡献者提交的通道。** @felixge 发现这样会使大家[越发乐意斟酌他们的补丁](http://felixge.de/2013/03/11/the-pull-request-hack.html)，他甚至发现，在他没有工作的一段时间，项目依然有新的维护者进来。
...
虽然并不是一直都有人在回答问题，但是你可以去增加一些信息，以让他人有能够接触的机会，越是尽早开始，越是能够获得帮助。
...
随着项目的愈加流行，会有更多的人对社区的决策开始感兴趣。即使社区没有大量的贡献者，如果项目拥有很多用户，就会发现大家的重点在决策上或者增加他们的 issues。
...
一些人希望得到指导。撰写一个清晰的示例。当然仍然可以表达失望、不高兴或者忧虑，但须做到心平气和。

保持你们的 **酷** 并不容易，但是展示领导力能促进社区健康的发展。开源会感谢你们。

### 将你们的 README 视为最高法则

README [不仅仅是一组指令](../starting-a-project/#writing-a-readme)。它也是一个谈论目标、产品愿景和路线的地方。
如果人们过分专注于讨论特定功能的优点，它可能有助于重新审视您的 README，并谈论项目的更高的愿景。关注 README 也会使对话变得个人化，以进行更多的建设性讨论。

### 专注过程，而不是结果

一些项目用投票的方式做重要决定。虽然看上去是明智的，投票强调的是得到一个“答案”，而不是倾听以及解决每个人的想法。
...
Atom Issues不存在投票系统的部分原因是因为 Atom 团队在所有情况下都不会遵循投票系统。有时我们必须选择我们认为是对的事，即使它不流行。（。。。）我能通过社区的反馈知道我能够提供什么以及做什么样的工作。
...
**不要为了获得决议而急于做出决定。在做一个决议之前请确保每个人已经知道以及所有的信息都是公开的。**
...
如果对话开始有解散的征兆，问团队：“我们下一步该做什么?”，然后再去开始下一轮的对话。
...
上下文非常的重要。考虑谁参与讨论，以及他们如何代表社区的其他人。

社区中的每个人是否都对这个问题感到不满，甚至参与其中？或者仅仅只是一部分人感到困惑？不要支取关心活跃者的声音，也要去关注那些社区中经常保持沉默的人。

如果某个问题并不代表社区广泛的需求，而 只是少数人的担心。如果这是一个反复出现的issue，没有一个清晰的解决方案，那么就将指向他们以前讨论的话题。

### 找出社区中的决策者

通过一个态度端正和目标清晰的对话，很多困难都是可以解决的。即使在富有成效的对话中，对于如何进行的意见也可能存在差异。在这些情况下，确定一个人或一组人，可以作为决策者。

决策者可以是项目的主要维护者，或者是大家投票选出的一个小团体。理想情况下，在使用 GOVERNANCE 文件之前，其实已经确定了决策者应该负责的事项了。

使用决策者应该是你们最后才去采取的手段。有分歧的 issues 是让社区成长和学习的绝佳机会。请利用这些机会并精诚合作，尽量找出问题的解决方案。

## 社区是开源的❤️

健康，蓬勃的社区每周都会有开源人士付出他们大量辛勤的劳动。许多贡献者都会说明可以工作或无法工作的原因，无论如何这些都是开源的名义进行。通过学习如何建设性地利用这股力量，你会帮助他人有一个难忘的开源体验。
